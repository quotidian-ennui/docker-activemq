...
- azul/zulu-openjdk-alpine:8-jre
 ...
 Since `eclipse-temurin` has arm images, `lewinc/activemq:latest` has been built for arm via github actions, zulu-openjdk-alpine doesn't have arm images (yet) for 8-jre so that's still only amd64. Everything should be being built via github actions.
